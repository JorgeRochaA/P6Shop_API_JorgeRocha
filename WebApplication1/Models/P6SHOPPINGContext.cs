...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("SERVER=.\\SQLEXPRESS01;DATABASE=P6SHOPPING;INTEGRATED SECURITY=TRUE;User Id=;Password=;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Country>(entity =>
            {
                entity.HasKey(e => e.Idcountry)
                    .HasName("PK__Country__D9D5A694AB5F86BC");

                entity.ToTable("Country");

                entity.HasIndex(e => e.CountryCode, "UQ__Country__5D9B0D2CDCE9036C")
                    .IsUnique();

                entity.HasIndex(e => e.CountryName, "UQ__Country__E056F20194946A23")
                    .IsUnique();
            ...
            modelBuilder.Entity<Currency>(entity =>
            {
                entity.HasKey(e => e.Idcurrency)
                    .HasName("PK__Currency__50890739AD0852EA");
            ...
            modelBuilder.Entity<Inventory>(entity =>
            {
                entity.HasKey(e => e.Idinventory)
                    .HasName("PK__Inventor__CD45C7BE17CB8780");
            ...
            modelBuilder.Entity<Invoice>(entity =>
            {
                entity.HasKey(e => e.Idinvoice)
                    .HasName("PK__Invoice__4DA85D70E071743B");
            ...
            modelBuilder.Entity<InvoiceInventory>(entity =>
            {
                entity.HasKey(e => new { e.InvoiceIdinvoice, e.InventoryIdinventory })
                    .HasName("PK__Invoice___2623EC5CBA1C5EA8");
            ...
            modelBuilder.Entity<ItemPicture>(entity =>
            {
                entity.HasKey(e => e.IditemPicture)
                    .HasName("PK__ItemPict__2FBB4E0954438A23");
            ...
            modelBuilder.Entity<PaymentMethod>(entity =>
            {
                entity.HasKey(e => e.IdpaymentMethod)
                    .HasName("PK__PaymentM__29948213DE6CA416");
            ...
            modelBuilder.Entity<Shipping>(entity =>
            {
                entity.HasKey(e => e.Idshipping)
                    .HasName("PK__Shipping__3ED42B5EADC7FC5A");
            ...
            modelBuilder.Entity<ShippingChannel>(entity =>
            {
                entity.HasKey(e => e.IdshippingChannel)
                    .HasName("PK__Shipping__2B5DF841193A052D");
            ...
            modelBuilder.Entity<Store>(entity =>
            {
                entity.HasKey(e => e.Idstore)
                    .HasName("PK__Store__BD8985FAC00683B9");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                entity.HasKey(e => e.Iduser)
                    .HasName("PK__User__EAE6D9DF6D575F3A");

                entity.ToTable("User");

                entity.HasIndex(e => e.Email, "UQ__User__A9D1053452C420B2")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                entity.HasKey(e => e.IduserRole)
                    .HasName("PK__UserRole__5A7AF781C45C162B");
            ...
            modelBuilder.Entity<UserStore>(entity =>
            {
                entity.HasKey(e => new { e.Iduser, e.Idstore })
                    .HasName("PK__User_Sto__513E41803A819990");
